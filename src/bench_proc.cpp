...
namespace JanSordid::ExampleDataModel
{
	...
	template void BM_SimulateProc<Entity1>( benchmark::State & state );
	template void BM_SimulateProc<Entity2>( benchmark::State & state );
	template void BM_SimulateProc<Entity3>( benchmark::State & state );
}
