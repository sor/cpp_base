...
//  static_assert( sizeof(Entity3)      == 72 );
    ...
    // benchmark::ClobberMemory();
    //*
    BENCHMARK( BM_SimulateOOP<Entity0>     )->RangeMultiplier( 2 )->Range( 1<<4, 1<<16 );
    BENCHMARK( BM_SimulateProc<Entity1>    )->RangeMultiplier( 2 )->Range( 1<<4, 1<<16 );
    BENCHMARK( BM_SimulateProc<Entity2>    )->RangeMultiplier( 2 )->Range( 1<<4, 1<<16 );
    BENCHMARK( BM_SimulateProc<Entity3>    )->RangeMultiplier( 2 )->Range( 1<<4, 1<<17 );
    BENCHMARK( BM_SimulateProcOpt<Entity2> )->RangeMultiplier( 2 )->Range( 1<<4, 1<<17 );
    BENCHMARK( BM_SimulateProcOpt<Entity3> )->RangeMultiplier( 2 )->Range( 1<<4, 1<<17 );
    BENCHMARK( BM_SimulateDOD              )->RangeMultiplier( 2 )->Range( 1<<4, 1<<18 );
    //*/
}
